...
const REASONS = [
  {
    num: '01',
    title: '積み上げてきた実績',
    desc: '制作クリエイティブは1,000本以上、支援アカウント数は150以上。運用と制作を重ねる中で、成果に繋がる勝ち筋を蓄積してきました。',
  },
  {
    num: '02',
    title: '成果起点のチーム体制',
  ...
  },
  {
    num: '03',
    title: 'クリエイターとつくる発信',
    desc: 'SNSで伝わる感覚を持つ現役のクリエイター視点も掛け合わせます。クライアントの魅力を、ユーザーに届く表現へと磨き上げます。',
  },
  {
    num: '04',
    title: '伴走し続ける熱量',
    desc: '運用現場に深く入り込みながら改善を積み重ねます。外部パートナーではなく、同じ目線で走る伴走者として支援します。',
  },
  {
    num: '05',
    title: '希少性の高いThreads知見',
    desc: '本格的に取り組む企業が少ないThreads領域にいち早く向き合い、運用知見を蓄積。媒体の特性を捉えた設計で、先行者メリットを成果につなげます。',
  },
];
