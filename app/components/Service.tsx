...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    desc: '業界では珍しいThreadsに特化し、SNS運用代行に必要な設計・投稿作成・分析・提案スキルを実践的に学ぶプログラムです。学んで終わりではなく、実務に近い経験までサポート。現場に近い環境で、SNS運用代行としての実践力を身につけられます。',
    bullets: [
    ...
    notes: [
      ...
      '※案件のご案内は、カリキュラムの修了状況、スキル、対応品質、稼働状況、案件状況等を踏まえて当社が判断します。',
