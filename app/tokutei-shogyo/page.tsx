...
const INFO: { label: string; value: React.ReactNode }[] = [
  ...
  },
  {
    ...
    value: (
      <div className="space-y-3">
        <p>
          受講開始後（契約書面〔電磁的記録を含む〕を受領した日から起算して8日を経過した後）は、書面または電磁的方法によるお申し出により、将来に向かって中途解約が可能です。もっとも、本プログラムは教材・動画等のデジタルコンテンツの提供を含む役務であることの性質上、原則として受講料の返金はいたしません。ただし、(1) 当社の責めに帰すべき事由により受講期間中にサポートの提供が途絶えた場合、(2) 当社が提供すべき動画等のコンテンツが提供されなかった場合、(3) その他当社の債務不履行がある場合には、この限りではありません。なお、返金をしない額が、当該解約により当社に通常生ずべき平均的な損害の額を超えるときは、その超える部分を返金します。
        </p>
        ...
        <span className="block text-xs text-brand-ink/60">
          ※上記の例外に該当し返金を行う場合の返金額は、解約時点の役務提供状況（教材閲覧・面談実施の有無等）に応じて個別に算定し、契約書面の定めに基づきご案内します。契約書面〔電磁的記録を含む〕を受領した日から起算して8日以内の無条件解約については、下記「クーリング・オフについて（自主解約特約）」によります。
        </span>
      </div>
    ),
  },
  {
    ...
    value:
      '本プログラムは通信販売にあたり、法律上のクーリング・オフ制度の適用はありません。ただし当社は、消費者保護の観点から自主基準として、契約書面（電磁的記録を含む）を受領した日から起算して8日間は、書面または電磁的記録によるお申し出により、無条件で解約（お支払い済み受講料の全額返金）を承ります。詳細は契約書面に記載します。',
  },
  {
      ...
      <section className="pt-32 md:pt-40 pb-16 md:pb-24">
        <div className="section-container max-w-4xl">
          ...
          <p className="mt-6 text-right text-xs text-brand-ink/50">
            制定日：2026年7月4日　／　改定日：2026年7月7日　／　株式会社たびびと
          </p>
        </div>
      </section>
